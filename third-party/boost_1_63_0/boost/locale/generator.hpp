...
namespace boost {
    ...
    namespace locale {
        ...
        public:
            ...
            /// without ".mo" extension. For example for file \c /usr/share/locale/he/LC_MESSAGES/Movie.mo
            /// it would be \c Movie.
            ///
            /// You can optionally specify the encoding of the keys in the sources by adding "/encoding_name"
            /// For example Movie/cp1255.
            ///
            ...
            /// domain name was "Movie/windows-1255" then for translation
            /// you should use dgettext("Movie","Hello")
            ///
            ///
