...
// and discussion here: http://Movies.msdn.com/b/vcMovie/archive/2014/11/12/visual-studio-2015-preview-now-available.aspx?PageIndex=2
#if defined(_CPPLIB_VER) && (_CPPLIB_VER == 650)
#  define BOOST_NO_CXX11_HDR_CODECVT
#endif
...
// and http://Movies.msdn.com/b/vcMovie/archive/2015/06/19/c-11-14-17-features-in-vs-2015-rtm.aspx
